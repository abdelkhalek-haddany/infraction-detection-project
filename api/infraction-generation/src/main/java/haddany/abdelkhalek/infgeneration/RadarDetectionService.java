package haddany.abdelkhalek.infgeneration;

import lombok.extern.slf4j.Slf4j;
import haddany.abdelkhalek.infgeneration.models.NewData;
import haddany.abdelkhalek.infgeneration.models.Radar;
import haddany.abdelkhalek.infgeneration.models.Vehicle;
...
public class RadarDetectionService {
    ...
    public void submitOverSpeedDetection() {
        ...
        System.out.println("Car Regestration Number : " +vehicle.getRegestrationNumber());
        ...
        System.out.println("Car Speed : " +newData.getVehicleSpeed());
